...
PROJECT_NAME = project_name + "_migration-delta"
DAG_ID = PROJECT_NAME
...
def build_execution(
    ...
    return CustomPapermillOperator(
        ...
        parameters={
            ...
            "isAirflow": True,
            "isExecuteMigrationProcess": True,
            "isMigrationToDelta": True,
        },
        logger=logger,
        base_dir=BASE_DIR,
...
with DAG(
    ...
    description=f"{PROJECT_DESC} - Migration (Delta)",
    ...
    build_execution_group(
        task_id="execute",
        config_file_name="config-migration",
